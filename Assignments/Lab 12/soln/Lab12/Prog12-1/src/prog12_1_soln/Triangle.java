...
public class Triangle extends ClosedCurve {
	...
	public Triangle(double base, double height) throws IllegalClosedCurveException {
		if(base < 0 || height < 0) {
			throw new IllegalClosedCurveException ("Illegal base or height is not positive number!");
		} else {
			this.base = base;
			this.height = height;
		}
	...
	public Triangle(double side1, double side2, double side3) throws IllegalClosedCurveException  {
		if(base < 0 || height < 0) {
			throw new IllegalClosedCurveException ("Illegal sides is not positive number!");
		} else {
	...
	private void computeBaseAndHeight(double x, double y, double z) throws IllegalClosedCurveException{
		if(x < 0 || y < 0 || z < 0) {
			throw new IllegalClosedCurveException ("Illegal base or height is not positive number!");
		} else {		
